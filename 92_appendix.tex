...
\section{main.as(ActionScript・2013年1月16日現在)}
{\scriptsize
\begin{verbatim}
package {
				...
				function(event:BulkProgressEvent):void{
					...
					for(var i:int=0; i<20;i++){
						...
						if(regPattern.test(img)){
							var bmd:BitmapData = thumbLoader.getBitmapData(
							imgXML.imgNS::Result[i].imgNS::Url.toString()
							);
							bmd = resize(bmd,1024/imgXML.imgNS::Result[i].imgNS::Width.toString(),
							1024/imgXML.imgNS::Result[i].imgNS::Height.toString());
						}else{
